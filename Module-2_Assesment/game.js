...
function Game() {
        ...
        roundData: [
            {
                round: 1,
                word: "kobe bryant",
                image: "/assets/imgs/kobe.jpg",
                audio: "/assets/audio/kobe.mp3",
                colorAccent: "#f9a004",
            ...
            },
            {
                round: 2,
                word: "chicago bulls",
                image: "/assets/imgs/bulls.jpg",
                audio: "/assets/audio/bulls.mp3",
                colorAccent: "#d91917",
            ...
            },
            {
                round: 3,
                word: "slam dunk",
                image: "/assets/imgs/dunk.jpg",
                audio: "/assets/audio/dunk.mp3",
                colorAccent: "#EC6F21",
            ...
            },
            {
                round: 4,
                word: "spud webb",
                image: "/assets/imgs/spud.jpg",
                audio: "/assets/audio/spud.mp3",
                colorAccent: "#C02427",
    ...
    const removeLetters = (letter) => {
        ...
        let letters = lettersLeft.filter(
            (letterToCheck) => letterToCheck !== letter
        );
    ...
    const playGame = ({ currentWord }, keyCode) => {
        ...
        const [wordIndex, isLetterFound] = findCorrectLetter(
            currentWord,
            letter
        );
